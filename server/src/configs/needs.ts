...
export const needs: NeedConfig[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { item: EntityName.TROLL_SCALES, tier: 2 },
      { item: EntityName.HENBANE, tier: 2 },
      { item: EntityName.OPIUM_POPPY, tier: 2 },
      { item: EntityName.BALE, tier: 2 },
